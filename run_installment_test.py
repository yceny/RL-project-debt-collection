...
idx = np.random.rand(len(trajs)) < 0.8
...
# df1_final = trajs1_pd_train[['loan_id', 'installment','state_done', 'cumulative_overdue_early_difference','gender','amount','num_loan','duration','year_ratio','diff_city','marriage','kids','month_in','housing','edu','motivation']].drop_duplicates()
# df1_final['opt_action_sarsa'] = opt_action1_sarsa

# print('type of trajectory is ', type(trajs1))
# qlearning1, qLearning1_reward = qlearning(trajs1, nS1, nA1, alpha = 0.4, gamma = gamma, epsilon = 0.9)
...
# df2_final = trajs2_pd_train[['loan_id', 'installment','state_done', 'cumulative_overdue_early_difference','gender','amount','num_loan','duration','year_ratio','diff_city','marriage','kids','month_in','housing','edu','motivation']].drop_duplicates()
# df2_final['opt_action_sarsa'] = opt_action2_sarsa

# qlearning2, qlearning2_reward = qlearning(trajs2, nS2, nA2, alpha = 0.4, gamma = gamma, epsilon = 0.9)
...
# trajs2_pd_test = trajs2_pd_test.merge(df2_final, on = ['loan_id', 'installment','state_done', 'cumulative_overdue_early_difference','gender','amount','num_loan','duration','year_ratio','diff_city','marriage','kids','month_in','housing','edu','motivation'], how = 'left')
# print('shape of test data ', trajs2_pd_test.shape)

# trajs2_pd_test = trajs2_pd_test.dropna(how='any')
# print('shape of test data after drop na ', trajs2_pd_test.shape)

# print('# of installment ', trajs2_pd_test[['loan_id','installment']].drop_duplicates().shape)
# print('# of loans ', trajs2_pd_test['loan_id'].drop_duplicates().shape)
...
# trajs2_pd_test['est_reward_qlearning'] = pred_final

# # actual reward under NN
# print('######################### reward under NN ###############################################')
# state_action_pairs = trajs2_pd_test[['gender','amount','num_loan','duration','year_ratio','diff_city','marriage','kids','month_in','housing','edu','motivation','state_done', 'cumulative_overdue_early_difference','action_num']].values
# rewards = trajs2_pd_test['reward'].values
...
# trajs2_pd_test['reward_nn'] = pred_final
...
# print('total reward actual nn ', trajs2_pd_test['reward_nn'].sum())
